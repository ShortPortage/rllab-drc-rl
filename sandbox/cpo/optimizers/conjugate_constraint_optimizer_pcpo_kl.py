...
from sandbox.cpo.optimizers.pcpo_diagnostics import record_projected_step_metrics
...
class ConjugateConstraintOptimizerPCPO_KL(Serializable):
    ...
    def optimize(self, 
        ...
        if optim_case >= 0:
            ...
            flat_descent_step_tr = np.zeros_like(flat_descent_step)
            # store the Lagrangain multiplier
        ...
        record_projected_step_metrics(
            reward_step=-flat_descent_step_tr,
            final_step=-flat_descent_step,
        )
